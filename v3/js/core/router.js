// router.js - Navegación SPA con soporte para todas las páginas
        ...
        setTimeout(() => {
            try {
                ...
                switch(page) {
                    ...
                    case 'create-project':
                        content = window.renderCreateProject?.() || '<div class="loading">Error: Create Project no disponible</div>';
                        setupFn = window.setupCreateProjectEvents;
                        break;
