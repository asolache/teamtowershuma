...
if (window.__projectJsLoaded) {
    console.log('⏩ project.js ya cargado, omitiendo segunda carga');
    return;
}
...
console.log('✅ project.js cargado con gestión completa de roles, entregables, transacciones y evaluación');
