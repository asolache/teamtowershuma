...
// Notaría & Cap Table · Slicing Pie Wallet
// =============================================================================
...
export default class LedgerView {
    ...
    async afterRender() {
        ...
        PageHeader.afterRender(
            ...
            (actionId) => {
                if (actionId === 'audit_cap') {
                    alert('🧠 Auditoría: Cap Table validada. Todos los Slices derivan de Work Orders auditadas o Inyecciones de Capital selladas.');
                }
            }
        );
        ...
        // Congelar Blockchain (placeholder)
        ...
        // Harvest simulation (placeholder)
    ...
    _renderGlobalPortfolio() {
        ...
        state.projects.forEach(p => {
            ...
            const mine    = harvest.find(h => h.userId === activeUserId || h.user === activeUserId);
