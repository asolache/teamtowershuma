...
| `test-joc.mjs` | veda 110 | Que el joc ensenyi el SOS i no el decori: que l'única manera de perdre sigui la cremada, que formar algú compti el doble, que el coneixement només s'obri ensenyant, que McGragor **ofereixi** una cosa que surt a compte avui, i que Molekulàndia no s'aconsegueixi ocupant el mapa |
