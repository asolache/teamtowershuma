...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 180 · 14145 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `.github/` | El CI: quines guardes corren i en quin ordre | 4 · 20 KB |
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 80 · 888 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 32 · 452 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 27 · 581 KB |
| `SOS/knowledge/dev/` | El backlog i la guia d'estil per a qui hi escriu | 2 · 107 KB |
...
| `SOS/knowledge/vision/` | Decisions d'arquitectura vives i auditories fetes | 10 · 88 KB |
