...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 205 · 14837 KB |
...
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 85 · 949 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 40 · 651 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 33 · 714 KB |
| `SOS/knowledge/dev/` | El backlog i la guia d'estil per a qui hi escriu | 3 · 143 KB |
...
| `SOS/knowledge/negoci/` | Model d'equip gestor, formació i mentoria | 7 · 91 KB |
| `SOS/knowledge/references/` | Els referents conceptuals, citats i no copiats | 2 · 11 KB |
| `SOS/knowledge/vision/` | Decisions d'arquitectura vives i auditories fetes | 13 · 130 KB |
...
25 pàgines HTML a l'arrel del repositori (`app.html`, `app_coops.html`, `clients.html`, `colla.html`…).
