...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 157 · 13628 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `.github/` | El CI: quines guardes corren i en quin ordre | 4 · 17 KB |
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 72 · 805 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 24 · 287 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 22 · 501 KB |
| `SOS/knowledge/dev/` | El backlog i la guia d'estil per a qui hi escriu | 2 · 77 KB |
...
| `SOS/knowledge/negoci/` | Model d'equip gestor, formació i mentoria | 2 · 30 KB |
