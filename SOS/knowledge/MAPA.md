...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 159 · 13668 KB |
...
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 73 · 817 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 25 · 296 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 22 · 505 KB |
| `SOS/knowledge/dev/` | El backlog i la guia d'estil per a qui hi escriu | 2 · 78 KB |
