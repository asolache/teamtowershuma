...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 186 · 14294 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `.github/` | El CI: quines guardes corren i en quin ordre | 4 · 21 KB |
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 81 · 898 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 34 · 493 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 28 · 597 KB |
| `SOS/knowledge/dev/` | El backlog i la guia d'estil per a qui hi escriu | 2 · 111 KB |
...
| `SOS/knowledge/negoci/` | Model d'equip gestor, formació i mentoria | 5 · 53 KB |
| `SOS/knowledge/references/` | Els referents conceptuals, citats i no copiats | 2 · 9 KB |
| `SOS/knowledge/vision/` | Decisions d'arquitectura vives i auditories fetes | 11 · 96 KB |
