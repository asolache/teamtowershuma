...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 160 · 13705 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `.github/` | El CI: quines guardes corren i en quin ordre | 4 · 18 KB |
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 73 · 818 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 25 · 318 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 23 · 516 KB |
| `SOS/knowledge/dev/` | El backlog i la guia d'estil per a qui hi escriu | 2 · 81 KB |
...
| `SOS/knowledge/negoci/` | Model d'equip gestor, formació i mentoria | 3 · 36 KB |
