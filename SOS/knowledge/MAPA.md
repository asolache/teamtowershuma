...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 200 · 14645 KB |
...
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 84 · 924 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 40 · 628 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 32 · 674 KB |
...
| `SOS/knowledge/negoci/` | Model d'equip gestor, formació i mentoria | 7 · 85 KB |
