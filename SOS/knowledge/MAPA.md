...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 186 · 14312 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 28 · 608 KB |
| `SOS/knowledge/dev/` | El backlog i la guia d'estil per a qui hi escriu | 2 · 117 KB |
