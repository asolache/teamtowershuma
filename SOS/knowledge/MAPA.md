...
|---|---|---|
| `SOS/` | L'aplicació i tot el que se serveix: una pàgina per cosa, autocontingudes | 153 · 13483 KB |
...
| `SOS/tests/` | Playwright contra les pàgines de debò, per `file://` | 71 · 778 KB |
| `SOS/tools/` | Les guardes que peten al CI quan una promesa deixa de ser certa | 21 · 234 KB |
...
| carpeta | què hi entra | fitxers |
|---|---|---|
| `SOS/knowledge/` | El que sabem: llei, referents, visió, negoci i aquest mapa | 22 · 479 KB |
