    ...
    async getHtml() {
        return `
            <style>
                ...
                .project-context-header p { font-size: 0.7rem; color: #00e676; text-transform: uppercase; font-weight: bold; margin: 0;}
                ...
                /* CAP TABLE SECTION */
                .cap-table-container { background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 16px; padding: 2rem; margin-bottom: 3rem; overflow-x: auto; }
                .cap-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 1rem; flex-wrap: wrap; gap: 10px;}
                ...
                /* LEDGER SECTION */
                .ledger-container { background: #0f0f14; border: 1px solid rgba(255,255,255,0.05); border-radius: 16px; overflow-x: auto; }
