...
export default class TestsView {
    ...
    executeViewScript() {
        ...
        btn.addEventListener('click', async () => {
            ...
            try {
                // ---------------------------------------------------------
                // FASE 1: INICIALIZACIÓN Y CONFIGURACIÓN (V6/V7)
                // ---------------------------------------------------------
                ...
                // ---------------------------------------------------------
                // FASE 7: PRIVACIDAD Y GOBERNANZA (V7.2)
                // ---------------------------------------------------------
                ...
                // ---------------------------------------------------------
                // FASE 9: INYECCIONES DE CAPITAL (V7.4)
                // ---------------------------------------------------------
                ...
                assert(capBlock.valorCongelado > 1000, "Slicing Pie: El dinero recibe multiplicador de riesgo financiero (> 1x)", "CAPITAL");
                ...
                if(passed === total) {
                    ...
                    terminal.innerHTML += `
                        <div style="margin-top: 25px; padding: 20px; border: 1px solid ${finalColor}; background: rgba(0, 230, 118, 0.1); border-radius: var(--border-radius-md); text-align: center; animation: fadeIn 0.5s ease-in;">
                            ...
                            <p style="color: white; margin-top: 10px; font-size: 1.1rem;">El Motor Core ha superado los ${total} vectores de prueba.</p>
