    ...
    async getHtml() {
        return `
            <style>
                ...
                .top-nav-focus { position: absolute; top: 0; left: 0; width: 100%; padding: 2rem; display: flex; justify-content: space-between; align-items: center; z-index: 10; flex-wrap: wrap; gap: 15px;}
                ...
                @media (max-width: 768px) {
                    ...
                    .omni-container { flex-direction: column; align-items: flex-start; width: 100%; border-radius: 12px;}
                ...
                <main class="focus-workspace">
                    ...
                    <div class="top-nav-focus">
                        ...
                        <div class="omni-container" id="omniContainer">
                            <span class="omni-label">▶ Selecciona Entregable y dale al Play:</span>
    ...
    executeViewScript() {
        ...
        state.projects.forEach(p => {
            if (p.transactions) {
                ...
                // Fallback para Owner si no tiene tareas propias (permite auditar visualmente)
        ...
        // Ordenar alfabéticamente por nombre de proyecto para mantener coherencia
        ...
        if (allMyTasks.length === 0) {
            ...
            this.dom.omniSelector.innerHTML = allMyTasks.map((t, idx) => 
                `<option value="${t.// v5/js/views/FocusView.js
import { store } from '../core/store.js';
import { Sidebar } from '../components/Sidebar.js';
