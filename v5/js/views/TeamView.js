...
export default class TeamView {
    constructor() {
        document.title = "La Colla (Equipo) | TeamTowers SOS";
    ...
    async getHtml() {
        return `
            <style>
                ...
                /* SIDE-PANEL: MARKETPLACE DEL ECOSISTEMA (V7.9) */
                ...
                <main class="workspace">
                    <div class="view-header">
                        ...
                        <div style="display: flex; gap: 10px; align-items: center; flex-wrap: wrap;">
                            ...
                            <button class="btn-invite" id="btnManualAdd" title="Crear nodo dummy para pruebas">⚡ Añadir Dummy</button>
                        </div>
                    </div>
    ...
    executeViewScript() {
        ...
        // El nuevo Sidebar maneja localStorage para saber qué proyecto abrir
        ...
        // -- MÓDULO MARKETPLACE LATERAL (V7.9) --
        ...
        document.getElementById('btnOpenMarketplace').addEventListener('click', () => {
            ...
            this.renderMarketplace(state.globalUsers, project.usuarios);
        });
    ...
    renderMarketplace(globalUsers, projUsers) {
        ...
        // Filtramos a los que YA ESTÁN en este proyecto para no mostrarlos
        let candidates = globalUsers.filter(gu => !projUsers.find(pu => pu.id === gu.id));

        // Aplicamos los filtros de búsqueda Geo y Nombre
        ...
        candidates.forEach(gu => {
            ...
            // EVENTO DE RECLUTAMIENTO: Trae al usuario desde el Ecosistema a esta Red específica
        ...
        try {
            ...
            if (userObj.profile) {
                ...
                if(uIdx > -1) {
                    ...
                    store.saveState(); // Usa el método nativo del store
                }
            }
            this.executeViewScript();
    ...
    renderRoles(project, globalUsers) {
        ...
        // Opciones del desplegable: SOLO usuarios que ya están en este proyecto
        ...
        roles.forEach(rol => {
            ...
            // SUGERENCIA IA: Busca en los usuarios asignados al proyecto
            if (!isAssigned) {
