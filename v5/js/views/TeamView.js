...
export default class TeamView {
    ...
    async getHtml() {
        return `
            <style>
                ...
                .user-id { color: #666; font-family: monospace; font-size: 0.75rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;}

                .role-slot { background: #0f0f14; border: 1px dashed rgba(255,255,255,0.1); border-radius: 12px; padding: 1rem; margin-bottom: 15px; display: flex; justify-content: space-between; align-items: center; gap: 15px;}
                ...
                .btn-invite { background: transparent; border: 1px solid #00b0ff; color: #00b0ff; padding: 10px 20px; border-radius: 8px; font-weight: bold; cursor: pointer; font-size: 0.9rem; transition: background 0.2s; height: 40px; display: flex; align-items: center; justify-content: center;}
                ...
                .pm-id { font-family: monospace; color: #888; font-size: 0.85rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;}
                ...
                <main class="workspace">
                    <div class="view-header">
                        <div>
                            ...
                            <p>Identidad real vía Google Auth. Asigna personas a las sillas del Castell.</p>
                        </div>
                ...
                <div class="profile-modal-overlay" id="userProfileModal">
                    <div class="profile-modal">
                        ...
                        <div class="pm-body">
                            ...
                            <div class="pm-ikigai">
                                ...
                                <div class="pm-prompt-text">
                                    ...
                                    <br>
                                    <span style="color: #888;">// La IA usará este prompt para sugerir a este usuario las tareas óptimas del Kanban.</span>
                                </div>
                            </div>

                            <div class="form-group" style="margin-bottom: 0;">
                                <label style="font-size: 0.75rem; color: #aaa; text-transform:uppercase; margin-bottom: 5px; display:block;">🛡️ Permisos (Gobernanza)</label>
                        ...
                        <div class="pm-footer">
                            ...
                            <div style="font-size: 0.8rem; color: #666;">ID Criptográfico Verificado ✓</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    renderUsers(project, globalUsers) {
        ...
        if (projUsers.length === 0) {
            container.innerHTML = `<p style="color:#666; font-size:0.9rem;">No hay usuarios en este Castell. Invita a alguien.</p>`;
            return;
        }
        ...
        projUsers.forEach((u, i) => {
            ...
            card.innerHTML = `
                ...
                <div style="font-size: 1rem; color: #555;">&rarr;</div>
            `;
    ...
    renderRoles(project, globalUsers) {
        ...
        // Asegurar que el array asignaciones exista
        ...
        if (roles.length === 0) {
            container.innerHTML = `<p style="color:#666; font-size:0.9rem;">No hay sillas definidas. Diseña el Castell en el Mapa VNA.</p>`;
            return;
        }
