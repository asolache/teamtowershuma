        ...
        return `
            <aside class="sidebar ${collapsedClass}" id="mainSidebar">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                    ...
                    <button id="btnToggleSidebar" style="background: transparent; border: 1px solid rgba(255,255,255,0.1); color: white; border-radius: 8px; padding: 6px 10px; cursor: pointer; width: ${isCollapsed ? '100%' : 'auto'}; transition: 0.2s;">
                        ${arrowIcon}
                    </button>
                </div>
                ...
                <div style="margin-bottom: 1.5rem; display: flex; flex-direction: column; gap: 4px;">
                    ...
                    <div style="font-size: 0.65rem; color: #666; text-transform: uppercase; font-weight: bold; margin: 15px 0 5px 0; padding-left: 10px; display: ${isCollapsed ? 'none' : 'block'};">Castell Activo</div>
