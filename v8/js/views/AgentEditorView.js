...
export default class AgentEditorView {
    ...
    async getHtml() {
        const headerConfig = {
            ...
            tagline: "Forja el Alma de los Agentes. Define su Prompt, Guardián y visualiza su Sandbox VNA."
        };
    ...
    renderList() {
        ...
        // Filtramos para mostrar solo a los Agentes IA
    ...
    async loadAgentData(id) {
        try {
            ...
            await KB.init();
            const promptNode = await KB.getNode(`prompt_global_${id.replace('@','')}`);
    ...
    async renderSandbox(agentId) {
        try {
            ...
            // Filtramos los memes o prompts asociados a este agente
            ...
            // Importación asíncrona de D3.js
            ...
            this.dom.canvas.innerHTML = '<div class="empty-state">⚠️ Modo Offline o Bloqueo del Navegador.<br>No se pudo cargar el visualizador interactivo D3.js.</div>';
        }
    }
}// v8/js/views/AgentEditorView.js
import { store } from '../core/store.js';
