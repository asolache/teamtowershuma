...
export default class PaperView {
    ...
    async getHtml() {
                ...
                <div class="app-layout">
                    ...
                    <main class="workspace" style="justify-content:center; align-items:center;">
                        <div class="glass-panel" style="text-align:center;">
                             ...
                             <p style="color:var(--text-muted);">Ve al Dashboard para instanciar un ecosistema antes de usar el Omni-Paper.</p>
                        </div>
                    </main>
        ...
        aiUsers.forEach(ai => {
            if (ai.id !== '@agent_web_deployer' && ai.id !== '@agent_codex_developer') {
        ...
        return `
            <style>
                ...
                .paper-container { width: 100%; max-width: 1200px; display: flex; flex-direction: column; gap: 1rem; margin-top: 1.5rem; padding-bottom: 8rem; flex: 1;}
                ...
                /* ==================================================================== */
                /* 🔥 MODO CHAT-IDE (ARTIFACTS) */
                /* ==================================================================== */
                .ide-mode-panel { display: grid; grid-template-columns: 400px 1fr; gap: 20px; flex: 1; min-height: 500px; height: 100%;}
                ...
                .chat-textarea { width: 100%; background: #050508; border: 1px solid #444; color: white; border-radius: 10px; padding: 12px; font-family: var(--font-main); font-size: 0.9rem; resize: none; outline: none; transition: 0.3s; box-sizing: border-box; min-height: 80px;}
                .chat-textarea:focus { border-color: var(--accent-blue); box-shadow: inset 0 0 10px rgba(0,176,255,0.1);}
                
                .btn-send { background: linear-gradient(135deg, var(--accent-blue), var(--accent-purple)); border: none; color: white; padding: 10px 15px; border-radius: 8px; font-weight: 900; cursor: pointer; transition: 0.2s; display: flex; align-items: center; justify-content: center; gap: 8px;}
                ...
                .sandbox-empty span { font-size: 3rem; display: block; margin-bottom: 1rem; opacity: 0.5;}
                    ...
                    <div class="paper-container">
                        ...
                        <div class="ide-mode-panel" id="ideModePanel">
                            ...
                            <div class="sandbox-panel" id="sandboxMount">
                                <div class="sandbox-empty" id="sbEmptyState">
                                    <span>⚡</span>Esperando inyección de código...
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="gtd-mode-panel" id="gtdModePanel">
                            ...
                            <div id="taskContextPanel" class="task-context-panel">
                                ...
                                <div class="pow-section">
                                    <div class="pow-input-group" style="flex:2;">
                                        <label>🔗 Enlace al Entregable (Opcional si escribes abajo)</label>
                                        <input type="text" id="inpPowLink" class="pow-input" placeholder="URL a Figma, Github, Drive...">
                                    </div>
                            ...
                            <div class="editor-wrapper" id="editorWrapper">
                                <label id="editorLabel" style="font-size:0.75rem; color:#888; text-transform:uppercase; font-weight:bold; margin-bottom:5px;">Cuerpo del Entregable (Proof of Work)</label>
    ...
    async executeViewScript() {
        ...
        this.loadProjectTasks = async (projId) => {
            ...
            let selectHtml = `<option value="ide" selected>🚀 Modo Chat-IDE (Renderizado en Vivo)</option>`;
            if (tasks.length > 0) {
    ...
    setIdeMode() {
        ...
        this.dom.ideModePanel.style.display = 'grid';
        if (window.innerWidth <= 768) this.dom.ideModePanel.style.display = 'flex';
    }
