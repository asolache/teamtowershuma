...
*Automatizar lo que se repite, poner valor a lo que no se ve*
...
De dónde sale un precio, y por qué el taller «Fent Pinya» y las demostraciones
castelleras no llevan tarifa publicada: lo que cuestan depende de cuánta gente
hay, cuánta colla hay que mover y a qué distancia, y publicar una cifra cerrada
sería o asustar a la mitad de quienes llamarían o tener que desdecirse en la
propuesta. Lo que sí se publica es el método, para que se pueda rehacer la suma
sin llamar.
...
|---|---|---|---|
| **N1 · Practicante** | Ejecuta el trabajo acompañado: recoge, registra, prepara sesiones y sostiene el día a día. | Perfil activo y aportaciones firmadas en el registro. | 35 €/h |
...
Lo que separa un nivel del siguiente no es la antigüedad: es **evidencia
registrada y verificable**, la misma que acredita a un gestor o a un mentor en
[la formación](SOS/formacio.html). La propuesta dice siempre qué persona hace
qué horas y a qué nivel.
...
### Antes de contratar, dos formularios

Ninguno de los dos envía nada solo: lo que escribes vive en tu navegador y no
sale de ahí hasta que pulsas enviar, que abre tu propio cliente de correo.
Comparten los bloques *quién eres* y *de dónde vienes* —declarados una vez en
`build-formularis.js`— así que quien hace el primero no vuelve a escribir su
nombre en el segundo.

- **[Diagnóstico](SOS/diagnostic.html)** — qué tenéis, qué os falta y qué
  itinerario formativo os toca. Tres minutos.
- **[Presupuesto](SOS/pressupost.html)** — eliges los paquetes y sale una
  propuesta borrador con el desglose: horquilla por paquete, horas por nivel si
  se contrata por horas, y qué falta para cerrarla.

### Y una página que explica el trabajo con IA

**[Flujos con IA](SOS/ia.html)** — automatizar los flujos tangibles con los
frenos escritos, poner nombre y medida a los intangibles, y cómo diseñamos webs
y proyectos transmedia con IA. La prueba del método es este mismo repositorio.
